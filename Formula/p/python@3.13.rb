class PythonAT313 < Formula
  ...
  url "https://www.python.org/ftp/python/3.13.0/Python-3.13.0rc2.tgz"
  sha256 "d08965c543f21d9949b2715b50d7e4619a5c13984a2ba6d2efcabf413d41479a"
  license "Python-2.0"
  ...
  # inline patch for python3.13.0rc1 Lib/sysconfig/__init__.py. Replace with formula patch?
  patch :DATA
  ...
  def install
    ...
    # not needed for embedded patch, but re-enable if a forumula patch is made?
    ...
    if OS.mac?
      ...
      system "cat", lib_cellar/"_sysconfigdata__darwin_darwin.py"
      inreplace lib_cellar/"_sysconfigdata__darwin_darwin.py",
                " Python.framework/",
                " #{opt_prefix}/Frameworks/Python.framework/"
    else
      # Prevent third-party packages from building against fragile Cellar paths
...
@@ -348,6 +358,7 @@ def _init_non_posix(vars):
